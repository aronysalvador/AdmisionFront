...
const GrupoEtnico = () => {
  const {
    addmissionForm: { percentage, grupoEtnico, siniestros }, microsoftReducer
    ...
    <div className={comunClass.root}>
      ...
      <div className={comunClass.beginContainerDesk}>
        <Cabecera
          ...
          dispatch={() => (siniestros.length > 0 ? dispatch(handleSetStep(5.831)) : dispatch(handleSetStep(3)))}
        ...
        <div className={comunClass.bottomElement}>
          <Button
            ...
            onClick={() => {
              ...
              dispatch(handleSetStep(5.4)) // to info empresa
            }}
          >
            Guardar
          </Button>
