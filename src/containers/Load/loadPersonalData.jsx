...
const LoadPersonalData = (props) => {
    ...
    return (<div className={comunClass.root}>
                ...
                <div className={useStyles.center} >
                    <img alt="load" src="./static/validandoDatos.png" className={useStyles.img} />
                </div>
                <div className={spaceStyle.space3} />
                <Typography color="textSecondary" gutterBottom className={useStyles.text1}>
                    Estamos validando<br /> 
                    tus datos
                </Typography>
                <div className={spaceStyle.space1} />
                <Typography color="textSecondary" gutterBottom className={useStyles.text2}>
                    Un momento por favor
                </Typography>
                <div className={useStyles.center2} >
                    <img alt="load" src="./static/Loader_1.gif" className={useStyles.img2} />
                </div>
            </div>
    );
}
