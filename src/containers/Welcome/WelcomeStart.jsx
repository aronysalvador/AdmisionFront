            ...
            <div className={welcomeStyle.beginContainer}>
                ...
                <div className={welcomeStyle.titleContainerCards}>
                    ...
                    <div className={welcomeStyle.divRow}>
                        ...
                        <path d="M23 5.5H18V3C18 1.6125 16.8875 0.5 15.5 0.5H10.5C9.1125 0.5 8 1.6125 8 3V5.5H3C1.6125 5.5 0.5125 6.6125 0.5125 8L0.5 21.75C0.5 23.1375 1.6125 24.25 3 24.25H23C24.3875 24.25 25.5 23.1375 25.5 21.75V8C25.5 6.6125 24.3875 5.5 23 5.5ZM15.5 5.5H10.5V3H15.5V5.5Z" fill="black"/>
                        </svg>
