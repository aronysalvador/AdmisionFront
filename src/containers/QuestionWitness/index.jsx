    ...
    return (
            <div className={classesComun.root}>
                ...
                { getTestigos.length === 0 
                    ?  <>
                        <div>
                            <Button className={classesComun.buttonAchs} variant="contained"  type="submit" onClick={()=> dispatch(handleSetStep(16))}>
                                Agregar Testigo
                            </Button>
                        </div>  
                        ...
                        <div>
                            <Button className={classesComun.buttonAchs2} variant="contained"  type="submit" onClick={()=> dispatch(handleSetStep(17))}>
                                No hubo Testigos
                            </Button>
                        </div> 
                    </>
                    ...
                    <>
                        <div  className={spaceStyle.space12} />
                        <div>
                            <Button className={classesComun.buttonAchs} variant="contained"  type="submit" onClick={()=> dispatch(handleSetStep(17))}>
                                Siguiente
                            </Button>
                        </div> 
                    </> 
