          ...
          <div className={comunClass.deskFlex}>
            <div className={state.antecePartP === true ? comunClass.roundedBlue : comunClass.roundedNormal} style={{minWidth: "315px", width: "100%"}}>
              <div className={comunClass.containerOpctionCompl}>
                <FormControlLabel
                  control={<BlueCheckbox id='DocComplementariosTrayecto-Check1' checked={state.antecePartP} onChange={handleChange}
name='antecePartP'
                           />}
            ...
            <div className={state.anteceConst === true ? comunClass.roundedBlue : comunClass.roundedNormal} style={{minWidth: "315px", width: "100%"}}>
              <div className={comunClass.containerOpctionCompl}>
                <FormControlLabel
                  control={<BlueCheckbox id='DocComplementariosTrayecto-Check2' checked={state.anteceConst} onChange={handleChange}
name='anteceConst'
                           />}
          ...
          <div className={comunClass.deskFlex}>
            <div className={state.anteceVideS === true ? comunClass.roundedBlue : comunClass.roundedNormal} style={{minWidth: "315px", width: "100%"}}>
              <div className={comunClass.containerOpctionCompl}>
                <FormControlLabel
                  control={<BlueCheckbox id='DocComplementariosTrayecto-Check3' checked={state.anteceVideS} onChange={handleChange}
name='anteceVideS'
                           />}
            ...
            <div className={state.anteceComSe === true ? comunClass.roundedBlue : comunClass.roundedNormal} style={{minWidth: "315px", width: "100%"}}>
              <div className={comunClass.containerOpctionCompl}>
                <FormControlLabel
                  control={<BlueCheckbox id='DocComplementariosTrayecto-Check4' checked={state.anteceComSe} onChange={handleChange}
name='anteceComSe'
                           />}
          ...
          <div className={state.anteceOtro === true ? comunClass.roundedBlue : comunClass.roundedNormal} style={{minWidth: "315px", width: "100%"}}>
            <div className={comunClass.containerOpctionCompl}>
              <FormControlLabel
                control={<BlueCheckbox id='DocComplementariosTrayecto-Check5' checked={state.anteceOtro} onChange={handleChange}
name='anteceOtro' className={comunClass.txtRadios}
                         />}
                label='Otro'
              />
            </div>
