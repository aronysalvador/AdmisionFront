...
const TipoAccidenteTrayecto = () => {
  const {
    addmissionForm: { percentage, sucursalEmpresaSiniestro, DireccionEmpresa, comunaEmpresa, CamposDocumentos, comunaTrabajoTrayecto, sucursalTrabajoTrayecto, urlMapaTrabajoTrayecto },
