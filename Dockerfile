...
ENV REACT_APP_NACIONALIDADES=$urlOrquestador/api/sap/nacionalidades/
ENV REACT_APP_IDIOMAS=$urlOrquestador/api/sap/idiomas/
ENV REACT_APP_PAISES=$urlOrquestador/api/sap/paises/
